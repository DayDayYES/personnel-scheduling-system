                ...
                <el-tab-pane label="工序视角" name="process">
                  <div class="chart-tab-content">
                    <div class="chart-info">
                      <i class="el-icon-info"></i>
                      {{ result.result.chart_info.process }}
              </div>
              <div class="chart-container">
                <img 
                  ...
                  class="gantt-chart"
                    ...
                    <div class="chart-actions">
                      <el-button size="small" type="primary" @click="downloadChart('process')">
                        <i class="el-icon-download"></i>
                        下载此图
                      </el-button>
                    </div>
                ...
                <el-tab-pane label="设备视角" name="workpoint">
                  <div class="chart-tab-content">
                    <div class="chart-info">
                      <i class="el-icon-info"></i>
                      {{ result.result.chart_info.workpoint }}
                    </div>
                    <div class="chart-container">
                      <img 
                    ...
                    <div class="chart-actions">
                      <el-button size="small" type="primary" @click="downloadChart('workpoint')">
                        <i class="el-icon-download"></i>
                        下载此图
                      </el-button>
                    </div>
                ...
                <el-tab-pane label="团队视角" name="team">
                  <div class="chart-tab-content">
                    ...
                    <div class="chart-actions">
                      <el-button size="small" type="primary" @click="downloadChart('team')">
                        <i class="el-icon-download"></i>
                        下载此图
                      </el-button>
                    </div>
